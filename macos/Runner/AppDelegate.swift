...
class AppDelegate: FlutterAppDelegate {
    ...
    override func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let channel = FlutterMethodChannel.init(name: "com.predidit.kazumi.tmdb/intent", binaryMessenger: controller.engine.binaryMessenger)
        self.menuChannel = FlutterMethodChannel.init(name: "com.predidit.kazumi.tmdb/appmenu",binaryMessenger: controller.engine.binaryMessenger)
        ...
        let storageChannel = FlutterMethodChannel.init(name: "com.predidit.kazumi.tmdb/storage", binaryMessenger: controller.engine.binaryMessenger)
