class ApiEndpoints {
  ...
  /// TMDB API Domain
  static const String tmdbAPIDomain = 'https://api.themoviedb.org/3';

  /// TMDB 图片 CDN
  static const String tmdbImageBaseURL = 'https://image.tmdb.org/t/p';

  /// TMDB 热门番剧（发现接口）
  static const String tmdbPopularAnime = '/discover/tv';

  /// TMDB 热门电影
  static const String tmdbPopularMovie = '/discover/movie';

  /// TMDB 搜索番剧
  static const String tmdbSearch = '/search/tv';

  /// TMDB 搜索电影
  static const String tmdbSearchMovie = '/search/movie';

  /// TMDB 多源搜索
  static const String tmdbMultiSearch = '/search/multi';

  /// TMDB 详情
  static const String tmdbDetail = '/tv/{0}';

  /// TMDB 电影详情
  static const String tmdbMovieDetail = '/movie/{0}';

  /// TMDB 季和剧集
  static const String tmdbSeason = '/tv/{0}/season/{1}';

  /// TMDB 评分最高番剧
  static const String tmdbTopRatedAnime = '/tv/top_rated';

  /// TMDB 评分最高电影
  static const String tmdbTopRatedMovie = '/movie/top_rated';

  /// TMDB 今日播出
  static const String tmdbAiringToday = '/tv/airing_today';
